    ...
    >
      <section className="space-y-6">
        ...
        <div className="space-y-2">
          {tiers.map((tier) => (
            <div key={tier.id} className="flex flex-col gap-2 rounded-xl border bg-card p-4 sm:flex-row sm:items-center sm:justify-between">
              <div>
          ...
          {!tiers.length && !isLoading && (
            <p className="text-sm text-muted-foreground">{t('loyalty.tiers.empty', 'No tiers configured yet.')}</p>
          )}
        </div>
