    ...
    <div className="space-y-6">
      ...
      <div className="space-y-2">
          ...
          >
            <div>
              <p className="font-medium">
                {item.patient?.fullName || item.patientId} · {item.points}{' '}
                {t('loyalty.adjustments.points', 'points')}{' '}
        ...
        {!items.length && !isLoading && (
          <EmptyState title={t('loyalty.adjustments.empty', 'No pending adjustments.')} />
        )}
      </div>
...
export default LoyaltyApprovalsPanel;
