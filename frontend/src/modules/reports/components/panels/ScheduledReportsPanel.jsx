...
/**
 * Scheduled-report list + create form.
 * Logic moved out of `pages/reports/ScheduledReportsPage` so the workspace
 * "Scheduled" tab and the standalone page render the same component.
 */
