        ...
        await this.sessionRepository.model
          .findByIdAndUpdate(
            id,
            {
              ...
              variationFromPlan: payload.variationFromPlan ?? session.variationFromPlan,
              aftercareTemplateId: payload.aftercareTemplateId ?? session.aftercareTemplateId,
              aftercareNotes: payload.aftercareNotes ?? session.aftercareNotes,
              painScore: payload.painScore ?? session.painScore,
